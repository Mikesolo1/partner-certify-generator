    ...
    <div className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center px-4 py-2 bg-brand/20 border border-brand/30 rounded-full text-sm font-medium backdrop-blur-sm mb-6">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand to-blue-400"> S3</span>?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/register">
              <Button size="lg" className="bg-brand hover:bg-brand/90 text-white text-lg px-8 py-4 shadow-lg group">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              <div className="text-2xl font-bold text-brand mb-2">Быстрый старт</div>
              <div className="text-sm text-gray-400">Обучение за 1 день</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-brand mb-2">Без рисков</div>
              <div className="text-sm text-gray-400">0₽ стартовых вложений</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-brand mb-2">Поддержка 24/7</div>
